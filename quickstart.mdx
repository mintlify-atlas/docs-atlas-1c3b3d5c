---
title: "Get Started with Setup Gulp in Under Five Minutes"
sidebarTitle: "Quickstart"
description: "Clone the Setup Gulp repository, install dependencies with Yarn, and start the BrowserSync dev server and Gulp file watcher in four steps."
---

Getting a fully functional Gulp build pipeline running for your Shopify theme takes less than five minutes. All you need is a terminal, Node.js, and Yarn. Once the dependencies are installed, two commands — `yarn serve` and `yarn start` — spin up BrowserSync and the file watcher simultaneously, giving you instant feedback as you work on styles, scripts, images, and fonts.
